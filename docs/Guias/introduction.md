...
- Se utiliza documentación **CRC (Clase-Responsabilidad-Colaborador)** en los encabezados de los archivos para explicitar y validar esta responsabilidad única.
